...
HD_PWD='F:/Comm_Refrences/Fourth_year/First_Term/VLSI/porject/Vivado/Multiplier_Divider.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_div.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_div.tcl
